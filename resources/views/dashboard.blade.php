                ...
                <div class="h-100">
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                    data-target="183.35">183.35</span>M </h4>
                    ...
                    <div class="row">
                                ...
                                <div class="card-header p-0 border-0 bg-light-subtle">
                                    <div class="row g-0 text-center">
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 border border-dashed border-start-0">
                                                <h5 class="mb-1"><span class="counter-value"
                                                        data-target="7585">7,585</span></h5>
                                        ...
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 border border-dashed border-start-0">
                                                <h5 class="mb-1">$<span class="counter-value"
                                                        data-target="22.89">22.89</span>k</h5>
                                ...
                                <div class="card-body p-0 pb-2">
                                    <div class="w-100">
                                        <div id="customer_impression_charts"
                                            ...
                                            <div id="apexchartskoe05zi8"
                                                class="apexcharts-canvas apexchartskoe05zi8 apexcharts-theme-"
                                                style="width: 875px; height: 370px;"><svg id="SvgjsSvg1805"
                                                    width="875" height="370" xmlns="http://www.w3.org/2000/svg"
                                                    version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    xmlns:svgjs="http://svgjs.dev"
                                                    class="apexcharts-svg apexcharts-zoomable hovering-zoom"
                                                    xmlns:data="ApexChartsNS" transform="translate(0, 0)">
                                                    <foreignObject x="0" y="0" width="875" height="370">
                                                        <div xmlns="http://www.w3.org/1999/xhtml"
                                                            style="position: relative; height: 100%; width: 100%;">
                                                            <div class="apexcharts-legend apexcharts-align-center apx-legend-position-bottom"
                                                                style="right: 0px; position: absolute; left: 20px; top: 340px; max-height: 185px;">
                                                                    ...
                                                                    style="margin: 0px 10px;"><span
                                                                        ...
                                                                        style="height: 16px; width: 16px; left: 0px; top: 0px;"><svg
                                                                            ...
                                                                            <defs id="SvgjsDefs1809">
                                                                                <clipPath id="gridRectMaskkoe05zi8">
                                                                                    <rect id="SvgjsRect1821"
                                                                                        width="762.0997536399148"
                                                                                        height="262.494" x="0" y="0"
                                                                                        rx="0" ry="0"
                                                                                ...
                                                                                <clipPath id="gridRectBarMaskkoe05zi8">
                                                                                    <rect id="SvgjsRect1822"
                                                                                        width="812.2670471191407"
                                                                                        height="268.694"
                                                                                        x="-25.083646739612927" y="-3.1"
                                                                                        rx="0" ry="0"
                                                                                        opacity="1" stroke-width="0"
                                                                                        stroke="none"
                                                                                        stroke-dasharray="0"
                                                                                ...
                                                                                <clipPath id="gridRectMarkerMaskkoe05zi8">
                                                                                ...
                                                                                <clipPath id="forecastMaskkoe05zi8">
                                                                                </clipPath>
                                                                                <clipPath id="nonForecastMaskkoe05zi8">
                                                                                </clipPath>
                                                                            </defs>
                                                                            <path id="SvgjsPath1810" d="M 0, 0
                       m -7, 0
                       a 7,7 0 1,0 14,0
                       a 7,7 0 1,0 -14,0" fill="#405189" fill-opacity="1" stroke="#ffffff" stroke-opacity="0.9"
                                                                        ...
                                                                        rel="1" i="0" data:default-text="Orders"
                                                                        data:collapsed="false"
                                                                ...
                                                                <div class="apexcharts-legend-series" rel="2"
                                                                    ...
                                                                    style="margin: 0px 10px;"><span
                                                                        ...
                                                                        data:collapsed="false"
                                                                        style="height: 16px; width: 16px; left: 0px; top: 0px;"><svg
                                                                            id="SvgjsSvg1811" width="100%"
                                                                            height="100%"
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            version="1.1"
                                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                            xmlns:svgjs="http://svgjs.dev">
                                                                            <defs id="SvgjsDefs1812"></defs>
                                                                            <path id="SvgjsPath1813" d="M 0, 0
                       m -7, 0
                       a 7,7 0 1,0 14,0
                       a 7,7 0 1,0 -14,0" fill="#0ab39c" fill-opacity="1" stroke="#ffffff" stroke-opacity="0.9"
                                                                        ...
                                                                        rel="2" i="1" data:default-text="Earnings"
                                                                        data:collapsed="false"
                                                                ...
                                                                <div class="apexcharts-legend-series" rel="3"
                                                                    seriesname="Refunds" data:collapsed="false"
                                                                    style="margin: 0px 10px;"><span
                                                                        class="apexcharts-legend-marker" rel="3"
                                                                        data:collapsed="false"
                                                                        style="height: 16px; width: 16px; left: 0px; top: 0px;"><svg
                                                                            id="SvgjsSvg1814" width="100%"
                                                                            height="100%"
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            version="1.1"
                                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                            xmlns:svgjs="http://svgjs.dev">
                                                                            <defs id="SvgjsDefs1815"></defs>
                                                                            <path id="SvgjsPath1816" d="M 0, 0
                       m -7, 0
                       a 7,7 0 1,0 14,0
                       a 7,7 0 1,0 -14,0" fill="#f06548" fill-opacity="1" stroke="#ffffff" stroke-opacity="0.9"
                                                                        ...
                                                                        rel="3" i="2" data:default-text="Refunds"
                                                                        data:collapsed="false"
                                                    ...
                                                    <rect id="SvgjsRect1819" width="0" height="0" x="0" y="0"
                                                        rx="0" ry="0" opacity="1" stroke-width="0"
                                                        stroke="none" stroke-dasharray="0" fill="#fefefe"></rect>
                                                    <g id="SvgjsG1824" class="apexcharts-datalabels-group"
                                                        transform="translate(0, 0) scale(1)"></g>
                                                    <g id="SvgjsG1825" class="apexcharts-datalabels-group"
                                                        transform="translate(0, 0) scale(1)"></g>
                                                    <g id="SvgjsG1924" class="apexcharts-yaxis" rel="0"
                                                        transform="translate(29.970962524414062, 0)">
                                                        <g id="SvgjsG1925" class="apexcharts-yaxis-texts-g"><text
                                                                id="SvgjsText1927"
                                                                ...
                                                                <tspan id="SvgjsTspan1928">120.00</tspan>
                                                                <title>120.00</title>
                                                            </text><text id="SvgjsText1930"
                                                                font-family="Helvetica, Arial, sans-serif" x="20"
                                                                y="77.41566666666667" text-anchor="end"
                                                                dominant-baseline="auto" font-size="11px"
                                                                font-weight="400" fill="#373d3f"
                                                                class="apexcharts-text apexcharts-yaxis-label "
                                                                style="font-family: Helvetica, Arial, sans-serif;">
                                                                <tspan id="SvgjsTspan1931">100.00</tspan>
                                                                <title>100.00</title>
                                                            </text><text id="SvgjsText1933"
                                                                font-family="Helvetica, Arial, sans-serif" x="20"
                                                                y="121.16466666666668" text-anchor="end"
                                                                dominant-baseline="auto" font-size="11px"
                                                                font-weight="400" fill="#373d3f"
                                                                class="apexcharts-text apexcharts-yaxis-label "
                                                                style="font-family: Helvetica, Arial, sans-serif;">
                                                                <tspan id="SvgjsTspan1934">80.00</tspan>
                                                                <title>80.00</title>
                                                            </text><text id="SvgjsText1936"
                                                                font-family="Helvetica, Arial, sans-serif" x="20"
                                                                y="164.91366666666667" text-anchor="end"
                                                                dominant-baseline="auto" font-size="11px"
                                                                font-weight="400" fill="#373d3f"
                                                                class="apexcharts-text apexcharts-yaxis-label "
                                                                style="font-family: Helvetica, Arial, sans-serif;">
                                                                <tspan id="SvgjsTspan1937">60.00</tspan>
                                                                <title>60.00</title>
                                                            </text><text id="SvgjsText1939"
                                                                font-family="Helvetica, Arial, sans-serif" x="20"
                                                                y="208.66266666666667" text-anchor="end"
                                                                dominant-baseline="auto" font-size="11px"
                                                                font-weight="400" fill="#373d3f"
                                                                class="apexcharts-text apexcharts-yaxis-label "
                                                                style="font-family: Helvetica, Arial, sans-serif;">
                                                                <tspan id="SvgjsTspan1940">40.00</tspan>
                                                                <title>40.00</title>
                                                            </text><text id="SvgjsText1942"
                                                                font-family="Helvetica, Arial, sans-serif" x="20"
                                                                y="252.41166666666666" text-anchor="end"
                                                                dominant-baseline="auto" font-size="11px"
                                                                font-weight="400" fill="#373d3f"
                                                                class="apexcharts-text apexcharts-yaxis-label "
                                                                style="font-family: Helvetica, Arial, sans-serif;">
                                                                <tspan id="SvgjsTspan1943">20.00</tspan>
                                                                <title>20.00</title>
                                                            </text><text id="SvgjsText1945"
                                                                font-family="Helvetica, Arial, sans-serif" x="20"
                                                                y="296.16066666666666" text-anchor="end"
                                                                dominant-baseline="auto" font-size="11px"
                                                                font-weight="400" fill="#373d3f"
                                                                class="apexcharts-text apexcharts-yaxis-label "
                                                                style="font-family: Helvetica, Arial, sans-serif;">
                                                                <tspan id="SvgjsTspan1946">0.00</tspan>
                                                                <title>0.00</title>
                                                            </text></g>
                                                    </g>
                                                    <g id="SvgjsG1807" class="apexcharts-inner apexcharts-graphical"
                                                        transform="translate(79.95460926402698, 30)">
                                                        <defs id="SvgjsDefs1806"></defs>
                                                        <line id="SvgjsLine1820" x1="345.90897892723405" y1="0"
                                                            x2="345.90897892723405" y2="262.494" stroke="#b6b6b6"
                                                            stroke-dasharray="3" stroke-linecap="butt"
                                                            class="apexcharts-xcrosshairs" x="345.90897892723405" y="0"
                                                            width="1" height="262.494" fill="#b1b9c4"
                                                        ...
                                                        <g id="SvgjsG1866" class="apexcharts-grid">
                                                            ...
                                                            <g id="SvgjsG1868" class="apexcharts-gridlines-vertical">
                                                                <line id="SvgjsLine1870" x1="0" y1="0"
                                                                    x2="0" y2="262.494" stroke="#e0e0e0"
                                                                    stroke-dasharray="0" stroke-linecap="butt"
                                                                    class="apexcharts-gridline">
                                                                </line>
                                                                <line id="SvgjsLine1871" x1="69.28179578544679"
                                                                    y1="0" x2="69.28179578544679" y2="262.494"
                                                                    stroke="#e0e0e0" stroke-dasharray="0"
                                                                    stroke-linecap="butt" class="apexcharts-gridline">
                                                                </line>
                                                                <line id="SvgjsLine1872" x1="138.56359157089358"
                                                                    y1="0" x2="138.56359157089358" y2="262.494"
                                                                    stroke="#e0e0e0" stroke-dasharray="0"
                                                                    stroke-linecap="butt" class="apexcharts-gridline">
                                                                </line>
                                                                <line id="SvgjsLine1873" x1="207.84538735634038"
                                                                    y1="0" x2="207.84538735634038" y2="262.494"
                                                                    stroke="#e0e0e0" stroke-dasharray="0"
                                                                    stroke-linecap="butt" class="apexcharts-gridline">
                                                                </line>
                                                                <line id="SvgjsLine1874" x1="277.12718314178716"
                                                                    y1="0" x2="277.12718314178716" y2="262.494"
                                                                    stroke="#e0e0e0" stroke-dasharray="0"
                                                                    stroke-linecap="butt" class="apexcharts-gridline">
                                                                </line>
                                                                <line id="SvgjsLine1875" x1="346.40897892723393"
                                                                    y1="0" x2="346.40897892723393" y2="262.494"
                                                                    stroke="#e0e0e0" stroke-dasharray="0"
                                                                    stroke-linecap="butt" class="apexcharts-gridline">
                                                                </line>
                                                                <line id="SvgjsLine1876" x1="415.6907747126807"
                                                                    y1="0" x2="415.6907747126807" y2="262.494"
                                                                    stroke="#e0e0e0" stroke-dasharray="0"
                                                                    stroke-linecap="butt" class="apexcharts-gridline">
                                                                </line>
                                                                <line id="SvgjsLine1877" x1="484.9725704981275"
                                                                    y1="0" x2="484.9725704981275" y2="262.494"
                                                                    stroke="#e0e0e0" stroke-dasharray="0"
                                                                    stroke-linecap="butt" class="apexcharts-gridline">
                                                                </line>
                                                                <line id="SvgjsLine1878" x1="554.2543662835743"
                                                                    y1="0" x2="554.2543662835743" y2="262.494"
                                                                    stroke="#e0e0e0" stroke-dasharray="0"
                                                                    stroke-linecap="butt" class="apexcharts-gridline">
                                                                </line>
                                                                <line id="SvgjsLine1879" x1="623.5361620690211"
                                                                    y1="0" x2="623.5361620690211" y2="262.494"
                                                                    stroke="#e0e0e0" stroke-dasharray="0"
                                                                    stroke-linecap="butt" class="apexcharts-gridline">
                                                                </line>
                                                                <line id="SvgjsLine1880" x1="692.8179578544679"
                                                                    y1="0" x2="692.8179578544679" y2="262.494"
                                                                    stroke="#e0e0e0" stroke-dasharray="0"
                                                                    stroke-linecap="butt" class="apexcharts-gridline">
                                                                </line>
                                                                <line id="SvgjsLine1881" x1="762.0997536399146"
                                                                    y1="0" x2="762.0997536399146" y2="262.494"
                                                                    stroke="#e0e0e0" stroke-dasharray="0"
                                                                    stroke-linecap="butt" class="apexcharts-gridline">
                                                                </line>
                                                            </g>
                                                            <line id="SvgjsLine1883" x1="0" y1="262.494"
                                                                x2="762.0997536399148" y2="262.494"
                                                                stroke="transparent" stroke-dasharray="0"
                                                                stroke-linecap="butt"></line>
                                                            <line id="SvgjsLine1882" x1="0" y1="1"
                                                                x2="0" y2="262.494" stroke="transparent"
                                                                stroke-dasharray="0" stroke-linecap="butt"></line>
                                                        </g>
                                                        <g id="SvgjsG1869" class="apexcharts-grid-borders"></g>
                                                        <g id="SvgjsG1826"
                                                            class="apexcharts-area-series apexcharts-plot-series">
                                                            <g id="SvgjsG1827" class="apexcharts-series" zIndex="0"
                                                                seriesName="Orders" data:longestSeries="true"
                                                                rel="1" data:realIndex="0">
                                                                <path id="SvgjsPath1830"
                                                                    d="M 0 188.1207 L 69.28179578544679 120.30975000000001 L 138.56359157089358 161.87130000000002 L 207.84538735634038 113.7474 L 277.12718314178716 155.30895 L 346.408978927234 129.05955 L 415.69077471268076 170.6211 L 484.97257049812754 166.24620000000002 L 554.2543662835743 91.87290000000002 L 623.5361620690211 148.7466 L 692.817957854468 124.68465 L 762.0997536399148 115.93485000000001 L 762.0997536399148 262.494 L 0 262.494z"
                                                                    fill="rgba(64,81,137,0.1)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-area" index="0"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 0 188.1207 L 69.28179578544679 120.30975000000001 L 138.56359157089358 161.87130000000002 L 207.84538735634038 113.7474 L 277.12718314178716 155.30895 L 346.408978927234 129.05955 L 415.69077471268076 170.6211 L 484.97257049812754 166.24620000000002 L 554.2543662835743 91.87290000000002 L 623.5361620690211 148.7466 L 692.817957854468 124.68465 L 762.0997536399148 115.93485000000001 L 762.0997536399148 262.494 L 0 262.494z"
                                                                    pathFrom="M 0 262.494 L 0 262.494 L 69.28179578544679 262.494 L 138.56359157089358 262.494 L 207.84538735634038 262.494 L 277.12718314178716 262.494 L 346.408978927234 262.494 L 415.69077471268076 262.494 L 484.97257049812754 262.494 L 554.2543662835743 262.494 L 623.5361620690211 262.494 L 692.817957854468 262.494 L 762.0997536399148 262.494z">
                                                                </path>
                                                                ...
                                                                <g id="SvgjsG1828"
                                                                    ...
                                                                    <g class="apexcharts-series-markers">
                                                                        <path id="SvgjsPath1950" d="M 0, 0
                       m -0, 0
                       a 0,0 0 1,0 0,0
                       a 0,0 0 1,0 -0,0" fill="#405189" fill-opacity="1" stroke="#ffffff" stroke-opacity="0.9"
                                                                            stroke-linecap="butt" stroke-width="2"
                                                                            stroke-dasharray="0" cx="0"
                                                                            cy="0" shape="circle"
                                                                            class="apexcharts-marker wu9j4x9yn"
                                                        ...
                                                        <g id="SvgjsG1832"
                                                            ...
                                                            <g id="SvgjsG1833" class="apexcharts-series" rel="1"
                                                                seriesName="Earnings" data:realIndex="1">
                                                                <path id="SvgjsPath1838"
                                                                    d="M -10.392269367817018 262.495 L -10.392269367817018 67.26508750000002 L 10.392269367817018 67.26508750000002 L 10.392269367817018 262.495 Z"
                                                                    fill="rgba(10,179,156,0.9)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-bar-area" index="1"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M -10.392269367817018 262.495 L -10.392269367817018 67.26508750000002 L 10.392269367817018 67.26508750000002 L 10.392269367817018 262.495 Z"
                                                                    pathFrom="M -10.392269367817018 262.495 L -10.392269367817018 262.495 L 10.392269367817018 262.495 L 10.392269367817018 262.495 L 10.392269367817018 262.495 L 10.392269367817018 262.495 L 10.392269367817018 262.495 L -10.392269367817018 262.495 Z"
                                                                    cy="67.26408750000002" cx="10.392269367817018" j="0"
                                                                    val="34" barHeight="195.2299125"
                                                                    barWidth="20.784538735634037"></path>
                                                                <path id="SvgjsPath1840"
                                                                    d="M 58.88952641762977 262.495 L 58.88952641762977 46.85617899999999 L 79.6740651532638 46.85617899999999 L 79.6740651532638 262.495 Z"
                                                                    fill="rgba(10,179,156,0.9)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-bar-area" index="1"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 58.88952641762977 262.495 L 58.88952641762977 46.85617899999999 L 79.6740651532638 46.85617899999999 L 79.6740651532638 262.495 Z"
                                                                    pathFrom="M 58.88952641762977 262.495 L 58.88952641762977 262.495 L 79.6740651532638 262.495 L 79.6740651532638 262.495 L 79.6740651532638 262.495 L 79.6740651532638 262.495 L 79.6740651532638 262.495 L 58.88952641762977 262.495 Z"
                                                                    cy="46.85517899999999" cx="79.6740651532638" j="1"
                                                                    val="65" barHeight="215.63882100000004"
                                                                    barWidth="20.784538735634037"></path>
                                                                <path id="SvgjsPath1842"
                                                                    d="M 128.17132220307656 262.495 L 128.17132220307656 112.12968700000002 L 148.9558609387106 112.12968700000002 L 148.9558609387106 262.495 Z"
                                                                    fill="rgba(10,179,156,0.9)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-bar-area" index="1"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 128.17132220307656 262.495 L 128.17132220307656 112.12968700000002 L 148.9558609387106 112.12968700000002 L 148.9558609387106 262.495 Z"
                                                                    pathFrom="M 128.17132220307656 262.495 L 128.17132220307656 262.495 L 148.9558609387106 262.495 L 148.9558609387106 262.495 L 148.9558609387106 262.495 L 148.9558609387106 262.495 L 148.9558609387106 262.495 L 128.17132220307656 262.495 Z"
                                                                    cy="112.12868700000001" cx="148.9558609387106" j="2"
                                                                    val="46" barHeight="150.36531300000001"
                                                                    barWidth="20.784538735634037"></path>
                                                                <path id="SvgjsPath1844"
                                                                    d="M 197.45311798852336 262.495 L 197.45311798852336 24.347318499999997 L 218.2376567241574 24.347318499999997 L 218.2376567241574 262.495 Z"
                                                                    fill="rgba(10,179,156,0.9)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-bar-area" index="1"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 197.45311798852336 262.495 L 197.45311798852336 24.347318499999997 L 218.2376567241574 24.347318499999997 L 218.2376567241574 262.495 Z"
                                                                    pathFrom="M 197.45311798852336 262.495 L 197.45311798852336 262.495 L 218.2376567241574 262.495 L 218.2376567241574 262.495 L 218.2376567241574 262.495 L 218.2376567241574 262.495 L 218.2376567241574 262.495 L 197.45311798852336 262.495 Z"
                                                                    cy="24.346318499999995" cx="218.2376567241574" j="3"
                                                                    val="68" barHeight="238.14768150000003"
                                                                    barWidth="20.784538735634037"></path>
                                                                <path id="SvgjsPath1846"
                                                                    d="M 266.73491377397016 262.495 L 266.73491377397016 92.88012699999999 L 287.5194525096042 92.88012699999999 L 287.5194525096042 262.495 Z"
                                                                    fill="rgba(10,179,156,0.9)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-bar-area" index="1"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 266.73491377397016 262.495 L 266.73491377397016 92.88012699999999 L 287.5194525096042 92.88012699999999 L 287.5194525096042 262.495 Z"
                                                                    pathFrom="M 266.73491377397016 262.495 L 266.73491377397016 262.495 L 287.5194525096042 262.495 L 287.5194525096042 262.495 L 287.5194525096042 262.495 L 287.5194525096042 262.495 L 287.5194525096042 262.495 L 266.73491377397016 262.495 Z"
                                                                    cy="92.87912699999998" cx="287.5194525096042" j="4"
                                                                    val="49" barHeight="169.61487300000005"
                                                                    barWidth="20.784538735634037"></path>
                                                                <path id="SvgjsPath1848"
                                                                    d="M 336.016709559417 262.495 L 336.016709559417 78.68357650000002 L 356.80124829505104 78.68357650000002 L 356.80124829505104 262.495 Z"
                                                                    fill="rgba(10,179,156,0.9)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-bar-area" index="1"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 336.016709559417 262.495 L 336.016709559417 78.68357650000002 L 356.80124829505104 78.68357650000002 L 356.80124829505104 262.495 Z"
                                                                    pathFrom="M 336.016709559417 262.495 L 336.016709559417 262.495 L 356.80124829505104 262.495 L 356.80124829505104 262.495 L 356.80124829505104 262.495 L 356.80124829505104 262.495 L 356.80124829505104 262.495 L 336.016709559417 262.495 Z"
                                                                    cy="78.68257650000001" cx="356.80124829505104" j="5"
                                                                    val="61" barHeight="183.81142350000002"
                                                                    barWidth="20.784538735634037"></path>
                                                                <path id="SvgjsPath1850"
                                                                    d="M 405.29850534486377 262.495 L 405.29850534486377 150.410062 L 426.0830440804978 150.410062 L 426.0830440804978 262.495 Z"
                                                                    fill="rgba(10,179,156,0.9)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-bar-area" index="1"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 405.29850534486377 262.495 L 405.29850534486377 150.410062 L 426.0830440804978 150.410062 L 426.0830440804978 262.495 Z"
                                                                    pathFrom="M 405.29850534486377 262.495 L 405.29850534486377 262.495 L 426.0830440804978 262.495 L 426.0830440804978 262.495 L 426.0830440804978 262.495 L 426.0830440804978 262.495 L 426.0830440804978 262.495 L 405.29850534486377 262.495 Z"
                                                                    cy="150.409062" cx="426.0830440804978" j="6"
                                                                    val="42" barHeight="112.08493800000002"
                                                                    barWidth="20.784538735634037"></path>
                                                                <path id="SvgjsPath1852"
                                                                    d="M 474.58030113031054 262.495 L 474.58030113031054 199.99955350000002 L 495.3648398659446 199.99955350000002 L 495.3648398659446 262.495 Z"
                                                                    fill="rgba(10,179,156,0.9)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-bar-area" index="1"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 474.58030113031054 262.495 L 474.58030113031054 199.99955350000002 L 495.3648398659446 199.99955350000002 L 495.3648398659446 262.495 Z"
                                                                    pathFrom="M 474.58030113031054 262.495 L 474.58030113031054 262.495 L 495.3648398659446 262.495 L 495.3648398659446 262.495 L 495.3648398659446 262.495 L 495.3648398659446 262.495 L 495.3648398659446 262.495 L 474.58030113031054 262.495 Z"
                                                                    cy="199.9985535" cx="495.3648398659446" j="7"
                                                                    val="44" barHeight="62.49544650000001"
                                                                    barWidth="20.784538735634037"></path>
                                                                <path id="SvgjsPath1854"
                                                                    d="M 543.8620969157573 262.495 L 543.8620969157573 60.002753500000004 L 564.6466356513913 60.002753500000004 L 564.6466356513913 262.495 Z"
                                                                    fill="rgba(10,179,156,0.9)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-bar-area" index="1"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 543.8620969157573 262.495 L 543.8620969157573 60.002753500000004 L 564.6466356513913 60.002753500000004 L 564.6466356513913 262.495 Z"
                                                                    pathFrom="M 543.8620969157573 262.495 L 543.8620969157573 262.495 L 564.6466356513913 262.495 L 564.6466356513913 262.495 L 564.6466356513913 262.495 L 564.6466356513913 262.495 L 564.6466356513913 262.495 L 543.8620969157573 262.495 Z"
                                                                    cy="60.00175350000001" cx="564.6466356513913" j="8"
                                                                    val="78" barHeight="202.49224650000002"
                                                                    barWidth="20.784538735634037"></path>
                                                                <path id="SvgjsPath1856"
                                                                    d="M 613.1438927012041 262.495 L 613.1438927012041 169.834618 L 633.9284314368381 169.834618 L 633.9284314368381 262.495 Z"
                                                                    fill="rgba(10,179,156,0.9)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-bar-area" index="1"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 613.1438927012041 262.495 L 613.1438927012041 169.834618 L 633.9284314368381 169.834618 L 633.9284314368381 262.495 Z"
                                                                    pathFrom="M 613.1438927012041 262.495 L 613.1438927012041 262.495 L 633.9284314368381 262.495 L 633.9284314368381 262.495 L 633.9284314368381 262.495 L 633.9284314368381 262.495 L 633.9284314368381 262.495 L 613.1438927012041 262.495 Z"
                                                                    cy="169.833618" cx="633.9284314368381" j="9"
                                                                    val="52" barHeight="92.66038200000001"
                                                                    barWidth="20.784538735634037"></path>
                                                                <path id="SvgjsPath1858"
                                                                    d="M 682.425688486651 262.495 L 682.425688486651 68.8838005 L 703.210227222285 68.8838005 L 703.210227222285 262.495 Z"
                                                                    fill="rgba(10,179,156,0.9)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-bar-area" index="1"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 682.425688486651 262.495 L 682.425688486651 68.8838005 L 703.210227222285 68.8838005 L 703.210227222285 262.495 Z"
                                                                    pathFrom="M 682.425688486651 262.495 L 682.425688486651 262.495 L 703.210227222285 262.495 L 703.210227222285 262.495 L 703.210227222285 262.495 L 703.210227222285 262.495 L 703.210227222285 262.495 L 682.425688486651 262.495 Z"
                                                                    cy="68.8828005" cx="703.210227222285" j="10"
                                                                    val="63" barHeight="193.61119950000003"
                                                                    barWidth="20.784538735634037"></path>
                                                                <path id="SvgjsPath1860"
                                                                    d="M 751.7074842720978 262.495 L 751.7074842720978 182.49995350000003 L 772.4920230077317 182.49995350000003 L 772.4920230077317 262.495 Z"
                                                                    fill="rgba(10,179,156,0.9)" fill-opacity="1"
                                                                    stroke-opacity="1" stroke-linecap="butt"
                                                                    stroke-width="0" stroke-dasharray="0"
                                                                    class="apexcharts-bar-area" index="1"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 751.7074842720978 262.495 L 751.7074842720978 182.49995350000003 L 772.4920230077317 182.49995350000003 L 772.4920230077317 262.495 Z"
                                                                    pathFrom="M 751.7074842720978 262.495 L 751.7074842720978 262.495 L 772.4920230077317 262.495 L 772.4920230077317 262.495 L 772.4920230077317 262.495 L 772.4920230077317 262.495 L 772.4920230077317 262.495 L 751.7074842720978 262.495 Z"
                                                                    cy="182.49895350000003" cx="772.4920230077317" j="11"
                                                                    val="67" barHeight="79.99504650000002"
                                                                    barWidth="20.784538735634037"></path>
                                                                <g id="SvgjsG1835" class="apexcharts-bar-goals-markers">
                                                                    <g id="SvgjsG1837"
                                                                        className="apexcharts-bar-goals-groups"
                                                                        class="apexcharts-hidden-element-shown"
                                                                        clip-path="url(#gridRectMarkerMaskkoe05zi8)">
                                                                    </g>
                                                                    <g id="SvgjsG1839"
                                                                        className="apexcharts-bar-goals-groups"
                                                                        class="apexcharts-hidden-element-shown"
                                                        ...
                                                        <g id="SvgjsG1861"
                                                            ...
                                                            <g id="SvgjsG1862" class="apexcharts-series" zIndex="2"
                                                                seriesName="Refunds" data:longestSeries="true"
                                                                rel="1" data:realIndex="2">
                                                                <path id="SvgjsPath1865"
                                                                    d="M 0 244.99440000000004 L 69.28179578544679 236.24460000000002 L 138.56359157089358 247.18185000000003 L 207.84538735634038 225.30735 L 277.12718314178716 216.55755000000002 L 346.408978927234 238.43205000000003 L 415.69077471268076 251.55675000000002 L 484.97257049812754 242.80695000000003 L 554.2543662835743 247.18185000000003 L 623.5361620690211 199.05795 L 692.817957854468 236.24460000000002 L 762.0997536399148 185.93325000000002"
                                                                    fill="none" fill-opacity="1"
                                                                    stroke="rgba(240,101,72,1)" stroke-opacity="1"
                                                                    stroke-linecap="butt" stroke-width="2.2"
                                                                    stroke-dasharray="8" class="apexcharts-line"
                                                                    index="2"
                                                                    clip-path="url(#gridRectBarMaskkoe05zi8)"
                                                                    pathTo="M 0 244.99440000000004 L 69.28179578544679 236.24460000000002 L 138.56359157089358 247.18185000000003 L 207.84538735634038 225.30735 L 277.12718314178716 216.55755000000002 L 346.408978927234 238.43205000000003 L 415.69077471268076 251.55675000000002 L 484.97257049812754 242.80695000000003 L 554.2543662835743 247.18185000000003 L 623.5361620690211 199.05795 L 692.817957854468 236.24460000000002 L 762.0997536399148 185.93325000000002"
                                                                    pathFrom="M 0 262.494 L 0 262.494 L 69.28179578544679 262.494 L 138.56359157089358 262.494 L 207.84538735634038 262.494 L 277.12718314178716 262.494 L 346.408978927234 262.494 L 415.69077471268076 262.494 L 484.97257049812754 262.494 L 554.2543662835743 262.494 L 623.5361620690211 262.494 L 692.817957854468 262.494 L 762.0997536399148 262.494"
                                                                    fill-rule="evenodd"></path>
                                                                <g id="SvgjsG1863"
                                                                    class="apexcharts-series-markers-wrap apexcharts-hidden-element-shown"
                                                                    data:realIndex="2">
                                                                    <g class="apexcharts-series-markers">
                                                                        <path id="SvgjsPath1951" d="M 0, 0
                       m -0, 0
                       a 0,0 0 1,0 0,0
                       a 0,0 0 1,0 -0,0" fill="#f06548" fill-opacity="1" stroke="#ffffff" stroke-opacity="0.9"
                                                                            stroke-linecap="butt" stroke-width="2"
                                                                            stroke-dasharray="0" cx="0"
                                                                            cy="0" shape="circle"
                                                                            class="apexcharts-marker w1edu4zhq"
                                                                            default-marker-size="0"></path>
                                                                    </g>
                                                                </g>
                                                            </g>
                                                            <g id="SvgjsG1829" class="apexcharts-datalabels"
                                                                data:realIndex="0"></g>
                                                            <g id="SvgjsG1834"
                                                                class="apexcharts-datalabels apexcharts-hidden-element-shown"
                                                                data:realIndex="1"></g>
                                                            <g id="SvgjsG1864" class="apexcharts-datalabels"
                                                                data:realIndex="2"></g>
                                                        </g>
                                                        <line id="SvgjsLine1884" x1="-21.983646739612926" y1="0"
                                                            x2="784.0834003795277" y2="0" stroke="#b6b6b6"
                                                            stroke-dasharray="0" stroke-width="1" stroke-linecap="butt"
                                                            class="apexcharts-ycrosshairs">
                                                        </line>
                                                        <line id="SvgjsLine1885" x1="-21.983646739612926" y1="0"
                                                            x2="784.0834003795277" y2="0" stroke-dasharray="0"
                                                            stroke-width="0" stroke-linecap="butt"
                                                            class="apexcharts-ycrosshairs-hidden"></line>
                                                        <g id="SvgjsG1886" class="apexcharts-xaxis"
                                                            transform="translate(0, 0)">
                                                            <g id="SvgjsG1887" class="apexcharts-xaxis-texts-g"
                                                                transform="translate(0, -4)"><text id="SvgjsText1889"
                                                                    font-family="Helvetica, Arial, sans-serif" x="0"
                                                                    y="290.494" text-anchor="middle"
                                                                    ...
                                                                    x="69.2817957854468" y="290.494" text-anchor="middle"
                                                                    dominant-baseline="auto" font-size="12px"
                                                                    font-weight="400" fill="#373d3f"
                                                                    class="apexcharts-text apexcharts-xaxis-label "
                                                                    style="font-family: Helvetica, Arial, sans-serif;">
                                                                    ...
                                                                    font-family="Helvetica, Arial, sans-serif"
                                                                    x="138.5635915708936" y="290.494" text-anchor="middle"
                                                                    dominant-baseline="auto" font-size="12px"
                                                                    font-weight="400" fill="#373d3f"
                                                                    class="apexcharts-text apexcharts-xaxis-label "
                                                                    style="font-family: Helvetica, Arial, sans-serif;">
                                                                    ...
                                                                    font-family="Helvetica, Arial, sans-serif"
                                                                    x="207.84538735634038" y="290.494" text-anchor="middle"
                                                                    dominant-baseline="auto" font-size="12px"
                                                                    font-weight="400" fill="#373d3f"
                                                                    class="apexcharts-text apexcharts-xaxis-label "
                                                                    style="font-family: Helvetica, Arial, sans-serif;">
                                                                    ...
                                                                    font-family="Helvetica, Arial, sans-serif"
                                                                    x="277.12718314178716" y="290.494" text-anchor="middle"
                                                                    dominant-baseline="auto" font-size="12px"
                                                                    font-weight="400" fill="#373d3f"
                                                                    class="apexcharts-text apexcharts-xaxis-label "
                                                                    style="font-family: Helvetica, Arial, sans-serif;">
                                                                    ...
                                                                    font-family="Helvetica, Arial, sans-serif"
                                                                    x="346.40897892723393" y="290.494"
                                                                    ...
                                                                    font-family="Helvetica, Arial, sans-serif"
                                                                    x="415.6907747126807" y="290.494" text-anchor="middle"
                                                                    dominant-baseline="auto" font-size="12px"
                                                                    font-weight="400" fill="#373d3f"
                                                                    class="apexcharts-text apexcharts-xaxis-label "
                                                                    style="font-family: Helvetica, Arial, sans-serif;">
                                                                    ...
                                                                    font-family="Helvetica, Arial, sans-serif"
                                                                    x="484.97257049812754" y="290.494"
                                                                    text-anchor="middle" dominant-baseline="auto"
                                                                    font-size="12px" font-weight="400" fill="#373d3f"
                                                                    class="apexcharts-text apexcharts-xaxis-label "
                                                                    style="font-family: Helvetica, Arial, sans-serif;">
                                                                    <tspan id="SvgjsTspan1911">Aug</tspan>
                                                                    <title>Aug</title>
                                                                </text><text id="SvgjsText1913"
                                                                    font-family="Helvetica, Arial, sans-serif"
                                                                    x="554.2543662835743" y="290.494" text-anchor="middle"
                                                                    dominant-baseline="auto" font-size="12px"
                                                                    font-weight="400" fill="#373d3f"
                                                                    class="apexcharts-text apexcharts-xaxis-label "
                                                                    style="font-family: Helvetica, Arial, sans-serif;">
                                                                    <tspan id="SvgjsTspan1914">Sep</tspan>
                                                                    <title>Sep</title>
                                                                </text><text id="SvgjsText1916"
                                                                    font-family="Helvetica, Arial, sans-serif"
                                                                    x="623.5361620690211" y="290.494" text-anchor="middle"
                                                                    dominant-baseline="auto" font-size="12px"
                                                                    font-weight="400" fill="#373d3f"
                                                                    class="apexcharts-text apexcharts-xaxis-label "
                                                                    style="font-family: Helvetica, Arial, sans-serif;">
                                                                    <tspan id="SvgjsTspan1917">Oct</tspan>
                                                                    <title>Oct</title>
                                                                </text><text id="SvgjsText1919"
                                                                    font-family="Helvetica, Arial, sans-serif"
                                                                    x="692.8179578544679" y="290.494" text-anchor="middle"
                                                                    dominant-baseline="auto" font-size="12px"
                                                                    font-weight="400" fill="#373d3f"
                                                                    class="apexcharts-text apexcharts-xaxis-label "
                                                                    style="font-family: Helvetica, Arial, sans-serif;">
                                                                    <tspan id="SvgjsTspan1920">Nov</tspan>
                                                                    <title>Nov</title>
                                                                </text><text id="SvgjsText1922"
                                                                    font-family="Helvetica, Arial, sans-serif"
                                                                    x="762.0997536399146" y="290.494" text-anchor="middle"
                                                                    dominant-baseline="auto" font-size="12px"
                                                                    font-weight="400" fill="#373d3f"
                                                                    class="apexcharts-text apexcharts-xaxis-label "
                                                                    style="font-family: Helvetica, Arial, sans-serif;">
                                                                    <tspan id="SvgjsTspan1923">Dec</tspan>
                                                                    <title>Dec</title>
                                                                </text></g>
                                                        </g>
                                                        ...
                                                        <rect id="SvgjsRect1952" width="0" height="0" x="0"
                                                            y="0" rx="0" ry="0" opacity="1"
                                                            stroke-width="0" stroke="none" stroke-dasharray="0"
                                                            fill="#fefefe" class="apexcharts-zoom-rect"></rect>
                                                        <rect id="SvgjsRect1953" width="0" height="0" x="0"
                                                            y="0" rx="0" ry="0" opacity="1"
                                                            stroke-width="0" stroke="none" stroke-dasharray="0"
                                                ...
                                                <div class="apexcharts-tooltip apexcharts-theme-light"
                                                    style="left: 432.364px; top: 79.1826px;">
                                                    ...
                                                    <div class="apexcharts-tooltip-series-group apexcharts-tooltip-series-group-0 apexcharts-active"
                                                        ...
                                                        <div class="apexcharts-tooltip-text"
                                                            ...
                                                            <div class="apexcharts-tooltip-y-group"><span
                                                                    class="apexcharts-tooltip-text-y-label">Orders</span><span
                                                                    class="apexcharts-tooltip-text-y-value">61</span>
                                                            </div>
                                                    ...
                                                    <div class="apexcharts-tooltip-series-group apexcharts-tooltip-series-group-1 apexcharts-active"
                                                        ...
                                                        <div class="apexcharts-tooltip-text"
                                                            style="font-family: Helvetica, Arial, sans-serif; font-size: 12px;">
                                                            <div class="apexcharts-tooltip-y-group"><span
                                                                    class="apexcharts-tooltip-text-y-label">Earnings</span><span
                                                                    class="apexcharts-tooltip-text-y-value">$84.03k</span>
                                                            </div>
                                                            <div class="apexcharts-tooltip-goals-group"><span
                                                                    class="apexcharts-tooltip-text-goals-label"></span><span
                                                                    class="apexcharts-tooltip-text-goals-value"></span>
                                                    ...
                                                    <div class="apexcharts-tooltip-series-group apexcharts-tooltip-series-group-2 apexcharts-active"
                                                        ...
                                                        <div class="apexcharts-tooltip-text"
                                                            style="font-family: Helvetica, Arial, sans-serif; font-size: 12px;">
                                                            <div class="apexcharts-tooltip-y-group"><span
                                                                    class="apexcharts-tooltip-text-y-label">Refunds</span><span
                                                                    class="apexcharts-tooltip-text-y-value">11
                                                                    Sales</span></div>
                                                            <div class="apexcharts-tooltip-goals-group"><span
                                                                    class="apexcharts-tooltip-text-goals-label"></span><span
                                                                    class="apexcharts-tooltip-text-goals-value"></span>
                                                ...
                                                <div class="apexcharts-xaxistooltip apexcharts-xaxistooltip-bottom apexcharts-theme-light"
                                                    style="left: 404.903px; top: 294.494px;">
                                                    <div class="apexcharts-xaxistooltip-text"
                                                        style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; min-width: 19.9219px;">
                                                        Jun</div>
                                                </div>
                                                <div
                            ...
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="sales-by-locations"
                                        ...
                                        style="height: 269px; background-color: transparent;" dir="ltr"
                                        class="jvm-container"><svg width="394" height="269">
                                            <defs></defs>
                                            <g id="jvm-regions-group"
                                                transform="scale(0.43777777777777777) translate(0, 15.69337649210135)">
                                                <path
                                                    ...
                                                    data-code="BD" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                ...
                                                <path
                                                    ...
                                                    data-code="BE" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="BF" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="BG" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="BA" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M707.48,403.47l0.69,-0.65l1.41,-0.91l-0.15,1.64l-0.81,-0.05l-0.61,0.58l-0.53,-0.6Z"
                                                    data-code="BN" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="BO" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="JP" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M495.45,425.39l-1.08,-2.99l1.14,-0.11l0.64,-1.19l0.76,0.09l0.65,1.83l-2.1,2.37Z"
                                                    data-code="BI" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="BW" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="BR" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="RS" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path d="M734.55,437.87l-0.09,-0.98l4.5,-0.86l-2.82,1.28l-1.59,0.55Z"
                                                    data-code="TL" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="TM" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="TJ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="RO" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="GW" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="GT" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="GR" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path d="M448.79,409.52l0.02,2.22l-4.09,0.0l0.69,-2.27l3.38,0.05Z"
                                                    data-code="GQ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="GY" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="GE" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="GB" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="GA" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="GN" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="GM" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="GL" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="GH" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="OM" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="TN" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="JO" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="HR" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="HT" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="HU" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="PT" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="PG" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="PE" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="PK" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="PH" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="PL" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="ZM" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="EH" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="EE" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="EG" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="ZA" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="EC" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IT" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="VN" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SB" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="ET" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SO" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="ZW" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="ES" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="ER" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M468.91,298.06l-1.24,-1.13l0.5,-2.11l0.88,-0.81l2.29,1.73l-0.52,0.71l-0.77,-0.3l-1.14,1.91Z"
                                                    data-code="ME" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MD" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MG" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MA" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="UZ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MM" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="ML" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MN" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="MR" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="UG" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MY" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MX" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IL" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    data-code="FI" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="FJ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="FK" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NI" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NL" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NO" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NA" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path d="M839.03,452.86l0.23,1.16l-0.44,0.03l-0.2,-1.47l0.42,0.28Z"
                                                    data-code="VU" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M838.79,471.67l-0.34,0.23l-2.9,-1.8l-3.27,-3.48l1.65,0.85l4.86,4.19Z"
                                                    data-code="NC" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NE" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NG" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NZ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="NP" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M472.78,298.18l-1.1,-1.47l0.98,-0.9l0.29,-0.94l2.0,1.84l-0.4,0.85l-1.77,0.62Z"
                                                    data-code="XK" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CI" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CH" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CO" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CN" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CM" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CL" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path d="M504.86,320.38l0.39,0.01l0.27,-0.07l-0.3,0.35l-0.36,-0.28Z"
                                                    data-code="XC" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CA" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CG" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CF" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CD" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CZ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M504.35,321.02l0.49,0.34l-1.34,0.65l-0.91,-0.29l-0.26,-0.55l2.02,-0.14Z"
                                                    data-code="CY" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CR" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="CU" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M500.35,482.11l0.5,2.14l-0.39,0.94l-1.04,0.22l-1.23,-1.25l-0.02,-0.69l0.84,-1.65l1.34,0.28Z"
                                                    data-code="SZ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SY" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="KG" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M506.26,414.59l1.87,-2.56l0.93,-2.15l-1.38,-4.08l-1.06,-1.6l2.82,-2.75l0.79,0.26l0.12,1.41l0.86,0.83l1.9,0.11l3.28,2.13l3.57,0.44l1.05,-1.12l1.96,-0.9l0.82,0.69l1.16,0.09l-1.78,2.45l0.03,9.12l1.3,1.94l-1.37,0.78l-0.67,1.03l-1.08,0.46l-0.34,1.67l-0.81,1.07l-0.45,1.55l-0.68,0.56l-3.2,-2.23l-0.35,-1.58l-8.86,-4.98l0.14,-1.6l-0.57,-1.04Z"
                                                    data-code="KE" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SS" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SR" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="KH" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M195.8,379.9l1.41,-1.21l2.24,1.46l0.98,-0.27l0.44,0.21l-0.27,1.07l-1.14,-0.03l-3.65,-1.23Z"
                                                    data-code="SV" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SK" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="KR" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SI" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="KP" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M540.8,336.41l0.38,0.92l-0.17,0.78l0.61,1.64l-0.95,0.04l-0.83,-1.35l-1.59,-0.2l1.34,-2.02l1.21,0.17Z"
                                                    data-code="KW" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SN" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SL" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="KZ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SA" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SE" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="SD" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="DO" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="DJ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="DK" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="DE" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="YE" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="DZ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="US" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="UY" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M510.37,325.96l-0.89,0.55l1.84,-3.86l0.6,0.08l0.24,0.7l-1.15,0.96l-0.64,1.57Z"
                                                    data-code="LB" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="LA" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M724.01,356.0l-0.73,1.52l-0.9,-1.56l-0.26,-1.81l1.38,-2.53l1.73,-1.8l0.64,0.46l-1.86,5.73Z"
                                                    data-code="TW" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path d="M266.64,389.17l0.28,-1.17l1.13,-0.22l-0.06,1.21l-1.35,0.18Z"
                                                    data-code="TT" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="TR" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M624.16,398.87l-1.82,0.48l-0.99,-1.67l-0.42,-3.47l0.95,-3.45l1.21,0.98l2.26,4.21l-0.34,2.34l-0.85,0.58Z"
                                                    data-code="LK" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="LV" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="LT" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path d="M436.07,271.5l-0.48,-0.1l0.29,-1.66l0.29,0.51l-0.1,1.25Z"
                                                    data-code="LU" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="LR" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M491.05,494.85l-0.48,0.15l-1.5,-1.78l1.12,-1.53l2.18,-1.51l1.52,1.34l-0.99,1.94l-1.23,0.4l-0.62,0.98Z"
                                                    data-code="LS" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="TH" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M596.66,558.28l-3.18,0.21l-0.05,-1.59l0.4,-1.7l1.28,0.9l2.08,0.42l-0.53,1.76Z"
                                                    data-code="TF" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="TG" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="TD" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="LY" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AE" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="VE" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AF" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IQ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IS" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IR" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AM" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AL" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AO" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AR" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AU" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AT" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IN" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="TZ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="AZ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="IE" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="ID" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="UA" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    d="M549.32,350.8l-0.76,-0.24l-0.14,-1.72l0.84,-1.35l0.47,0.54l0.04,1.41l-0.45,1.36Z"
                                                    data-code="QA" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                                <path
                                                    ...
                                                    data-code="MZ" fill="#f3f6f9" fill-opacity="1" stroke="#9599ad"
                                                    stroke-width="0.25" fill-rule="evenodd"
                                                    class="jvm-region jvm-element"></path>
                                            </g>
                                            ...
                                            <g id="jvm-markers-group">
                                                <circle data-index="0" cx="222.9003051655774" cy="151.46538940341662"
                                                    r="7" fill="#405189" fill-opacity="1" stroke="#FFF"
                                                    stroke-width="5" stroke-opacity="0.5"
                                                    class="jvm-marker jvm-element"></circle>
                                                <circle data-index="1" cx="299.7352177980878" cy="102.31960774890179"
                                                    r="7" fill="#0ab39c" fill-opacity="1" stroke="#FFF"
                                                    stroke-width="5" stroke-opacity="0.5"
                                                    class="jvm-marker jvm-element"></circle>
                                                <circle data-index="2" cx="67.70587500511557" cy="113.76945304428783"
                                                    r="7" fill="#0ab39c" fill-opacity="1" stroke="#FFF"
                                                    stroke-width="5" stroke-opacity="0.5"
                                                    class="jvm-marker jvm-element"></circle>
                                                <circle data-index="3" cx="137.58085886163752" cy="73.74960883136117"
                                                    r="7" fill="#0ab39c" fill-opacity="1" stroke="#FFF"
                                                    stroke-width="5" stroke-opacity="0.5"
                                                    class="jvm-marker jvm-element"></circle>
                                            </g>
                                            <g id="jvm-markers-labels-group"><text data-index="0" x="234.9003051655774"
                                                    y="151.46538940341662" dy="0.6ex" font-family="Verdana"
                                                    font-size="12" font-weight="500" cursor="default" fill="#374151"
                                                    class="jvm-marker jvm-element">Palestine</text><text data-index="1"
                                                    x="311.7352177980878" y="102.31960774890179" dy="0.6ex"
                                                    font-family="Verdana" font-size="12" font-weight="500"
                                                    cursor="default" fill="#374151"
                                                    class="jvm-marker jvm-element">Russia</text><text data-index="2"
                                                    x="79.70587500511557" y="113.76945304428783" dy="0.6ex"
                                                    font-family="Verdana" font-size="12" font-weight="500"
                                                    cursor="default" fill="#374151"
                                                    class="jvm-marker jvm-element">Canada</text><text data-index="3"
                                                    x="149.58085886163752" y="73.74960883136117" dy="0.6ex"
                                                    font-family="Verdana" font-size="12" font-weight="500"
                                                    cursor="default" fill="#374151"
                                                    class="jvm-marker jvm-element">Greenland</text></g>
                                        </svg></div>
                            ...
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    <div id="store-visits-source"
                                        ...
                                        class="apex-charts" dir="ltr" style="min-height: 333px;">
                                        <div id="apexchartsfq9561z6"
                                            class="apexcharts-canvas apexchartsfq9561z6 apexcharts-theme-"
                                            style="width: 394px; height: 333px;"><svg id="SvgjsSvg1954" width="394"
                                                height="333" xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                xmlns:xlink="http://www.w3.org/1999/xlink"
                                                xmlns:svgjs="http://svgjs.dev" class="apexcharts-svg"
                                                xmlns:data="ApexChartsNS" transform="translate(0, 0)">
                                                <foreignObject x="0" y="0" width="394" height="333">
                                                    <div xmlns="http://www.w3.org/1999/xhtml"
                                                        style="position: relative; height: 100%; width: 100%;">
                                                        <div class="apexcharts-legend apexcharts-align-center apx-legend-position-bottom"
                                                            style="right: 0px; position: absolute; left: 0px; top: 304px; max-height: 166.5px;">
                                                            <div class="apexcharts-legend-series" rel="1"
                                                                ...
                                                                style="margin: 4px 5px;"><span
                                                                    ...
                                                                    style="height: 16px; width: 16px; left: 0px; top: 0px;"><svg
                                                                        ...
                                                                        <defs id="SvgjsDefs1958">
                                                                            <clipPath id="gridRectMaskfq9561z6">
                                                                                <rect id="SvgjsRect1972" width="394"
                                                                                    height="295" x="0" y="0"
                                                                                    rx="0" ry="0"
                                                                                    opacity="1" stroke-width="0"
                                                                            ...
                                                                            <clipPath id="gridRectBarMaskfq9561z6">
                                                                                <rect id="SvgjsRect1973" width="400"
                                                                                    height="301" x="-3" y="-3"
                                                                                    rx="0" ry="0"
                                                                                    opacity="1" stroke-width="0"
                                                                                    stroke="none" stroke-dasharray="0"
                                                                            ...
                                                                            <clipPath id="gridRectMarkerMaskfq9561z6">
                                                                                <rect id="SvgjsRect1974" width="394"
                                                                                    height="295" x="0" y="0"
                                                                                    rx="0" ry="0"
                                                                                    opacity="1" stroke-width="0"
                                                                                    stroke="none" stroke-dasharray="0"
                                                                            ...
                                                                            <clipPath id="forecastMaskfq9561z6">
                                                                            </clipPath>
                                                                            <clipPath id="nonForecastMaskfq9561z6">
                                                                            </clipPath>
                                                                        </defs>
                                                                        <path id="SvgjsPath1959" d="M 0, 0
                       m -7, 0
                       a 7,7 0 1,0 14,0
                       a 7,7 0 1,0 -14,0" fill="#405189" fill-opacity="1" stroke="#ffffff" stroke-opacity="0.9"
                                                                            stroke-linecap="butt" stroke-width="1"
                                                                    ...
                                                                    rel="1" i="0" data:default-text="Direct"
                                                                    data:collapsed="false"
                                                                    style="color: rgb(55, 61, 63); font-size: 12px; font-weight: 400; font-family: Helvetica, Arial, sans-serif;">Direct</span>
                                                            </div>
                                                            <div class="apexcharts-legend-series" rel="2"
                                                                ...
                                                                style="margin: 4px 5px;"><span
                                                                    ...
                                                                    data:collapsed="false"
                                                                    style="height: 16px; width: 16px; left: 0px; top: 0px;"><svg
                                                                        id="SvgjsSvg1960" width="100%"
                                                                        height="100%"
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        version="1.1"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                        xmlns:svgjs="http://svgjs.dev">
                                                                        <defs id="SvgjsDefs1961"></defs>
                                                                        <path id="SvgjsPath1962" d="M 0, 0
                       m -7, 0
                       a 7,7 0 1,0 14,0
                       a 7,7 0 1,0 -14,0" fill="#0ab39c" fill-opacity="1" stroke="#ffffff" stroke-opacity="0.9"
                                                                            stroke-linecap="butt" stroke-width="1"
                                                                    ...
                                                                    rel="2" i="1" data:default-text="Social"
                                                                    data:collapsed="false"
                                                                    style="color: rgb(55, 61, 63); font-size: 12px; font-weight: 400; font-family: Helvetica, Arial, sans-serif;">Social</span>
                                                            </div>
                                                            <div class="apexcharts-legend-series" rel="3"
                                                                ...
                                                                style="margin: 4px 5px;"><span
                                                                    ...
                                                                    data:collapsed="false"
                                                                    style="height: 16px; width: 16px; left: 0px; top: 0px;"><svg
                                                                        id="SvgjsSvg1963" width="100%"
                                                                        height="100%"
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        version="1.1"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                        xmlns:svgjs="http://svgjs.dev">
                                                                        <defs id="SvgjsDefs1964"></defs>
                                                                        <path id="SvgjsPath1965" d="M 0, 0
                       m -7, 0
                       a 7,7 0 1,0 14,0
                       a 7,7 0 1,0 -14,0" fill="#f7b84b" fill-opacity="1" stroke="#ffffff" stroke-opacity="0.9"
                                                                            stroke-linecap="butt" stroke-width="1"
                                                                            stroke-dasharray="0" cx="0"
                                                                            cy="0" shape="circle"
                                                                            class="apexcharts-legend-marker apexcharts-marker apexcharts-marker-circle"
                                                                    ...
                                                                    rel="3" i="2" data:default-text="Email"
                                                                    data:collapsed="false"
                                                                    style="color: rgb(55, 61, 63); font-size: 12px; font-weight: 400; font-family: Helvetica, Arial, sans-serif;">Email</span>
                                                            </div>
                                                            <div class="apexcharts-legend-series" rel="4"
                                                                seriesname="Other" data:collapsed="false"
                                                                style="margin: 4px 5px;"><span
                                                                    class="apexcharts-legend-marker" rel="4"
                                                                    data:collapsed="false"
                                                                    style="height: 16px; width: 16px; left: 0px; top: 0px;"><svg
                                                                        id="SvgjsSvg1966" width="100%"
                                                                        height="100%"
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        version="1.1"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                        xmlns:svgjs="http://svgjs.dev">
                                                                        <defs id="SvgjsDefs1967"></defs>
                                                                        <path id="SvgjsPath1968" d="M 0, 0
                       m -7, 0
                       a 7,7 0 1,0 14,0
                       a 7,7 0 1,0 -14,0" fill="#f06548" fill-opacity="1" stroke="#ffffff" stroke-opacity="0.9"
                                                                            stroke-linecap="butt" stroke-width="1"
                                                                    ...
                                                                    rel="4" i="3" data:default-text="Other"
                                                                    data:collapsed="false"
                                                                    style="color: rgb(55, 61, 63); font-size: 12px; font-weight: 400; font-family: Helvetica, Arial, sans-serif;">Other</span>
                                                            </div>
                                                            <div class="apexcharts-legend-series" rel="5"
                                                                seriesname="Referrals" data:collapsed="false"
                                                                style="margin: 4px 5px;"><span
                                                                    class="apexcharts-legend-marker" rel="5"
                                                                    data:collapsed="false"
                                                                    style="height: 16px; width: 16px; left: 0px; top: 0px;"><svg
                                                                        id="SvgjsSvg1969" width="100%"
                                                                        height="100%"
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        version="1.1"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                        ...
                                                                        <path id="SvgjsPath1971" d="M 0, 0
                       m -7, 0
                       a 7,7 0 1,0 14,0
                       a 7,7 0 1,0 -14,0" fill="#299cdb" fill-opacity="1" stroke="#ffffff" stroke-opacity="0.9"
                                                                            stroke-linecap="butt" stroke-width="1"
                                                                            stroke-dasharray="0" cx="0"
                                                                            cy="0" shape="circle"
                                                                            class="apexcharts-legend-marker apexcharts-marker apexcharts-marker-circle"
                                                                    ...
                                                                    rel="5" i="4" data:default-text="Referrals"
                                                                    data:collapsed="false"
                                                                    style="color: rgb(55, 61, 63); font-size: 12px; font-weight: 400; font-family: Helvetica, Arial, sans-serif;">Referrals</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <style type="text/css">
                                                ...
                                                <g id="SvgjsG1956" class="apexcharts-inner apexcharts-graphical"
                                                    transform="translate(0, 0)">
                                                    <defs id="SvgjsDefs1955"></defs>
                                                    <g id="SvgjsG1977" class="apexcharts-pie">
                                                        <g id="SvgjsG1978" transform="translate(0, 0) scale(1)">
                                                            <circle id="SvgjsCircle1979" r="89.63658536585366"
                                                                cx="197" cy="147.5" fill="transparent">
                                                            </circle>
                                                            <g id="SvgjsG1980" class="apexcharts-slices">
                                                                <g id="SvgjsG1981"
                                                                    class="apexcharts-series apexcharts-pie-series"
                                                                    seriesName="Direct" rel="1"
                                                                    data:realIndex="0">
                                                                    <path id="SvgjsPath1982"
                                                                        d="M 197 9.597560975609753 A 137.90243902439025 137.90243902439025 0 0 1 334.8104371874472 152.53647605775615 L 286.57678417184064 150.7737094375415 A 89.63658536585366 89.63658536585366 0 0 0 197 57.86341463414634 L 197 9.597560975609753 z "
                                                                        fill="rgba(64,81,137,1)" fill-opacity="1"
                                                                        stroke-opacity="1" stroke-linecap="butt"
                                                                        stroke-width="0" stroke-dasharray="0"
                                                                        ...
                                                                        data:value="44"
                                                                        data:pathOrig="M 197 9.597560975609753 A 137.90243902439025 137.90243902439025 0 0 1 334.8104371874472 152.53647605775615 L 286.57678417184064 150.7737094375415 A 89.63658536585366 89.63658536585366 0 0 0 197 57.86341463414634 L 197 9.597560975609753 z ">
                                                                    </path>
                                                                </g>
                                                                <g id="SvgjsG1985"
                                                                    class="apexcharts-series apexcharts-pie-series"
                                                                    seriesName="Social" rel="2"
                                                                    data:realIndex="1">
                                                                    <path id="SvgjsPath1986"
                                                                        d="M 334.8104371874472 152.53647605775615 A 137.90243902439025 137.90243902439025 0 0 1 133.94516839111157 270.1424514580917 L 156.01435945422253 227.21759344775964 A 89.63658536585366 89.63658536585366 0 0 0 286.57678417184064 150.7737094375415 L 334.8104371874472 152.53647605775615 z "
                                                                        fill="rgba(10,179,156,1)" fill-opacity="1"
                                                                        stroke-opacity="1" stroke-linecap="butt"
                                                                        stroke-width="0" stroke-dasharray="0"
                                                                        ...
                                                                        data:pathOrig="M 334.8104371874472 152.53647605775615 A 137.90243902439025 137.90243902439025 0 0 1 133.94516839111157 270.1424514580917 L 156.01435945422253 227.21759344775964 A 89.63658536585366 89.63658536585366 0 0 0 286.57678417184064 150.7737094375415 L 334.8104371874472 152.53647605775615 z ">
                                                                    </path>
                                                                </g>
                                                                <g id="SvgjsG1989"
                                                                    class="apexcharts-series apexcharts-pie-series"
                                                                    seriesName="Email" rel="3"
                                                                    data:realIndex="2">
                                                                    <path id="SvgjsPath1990"
                                                                        d="M 133.94516839111157 270.1424514580917 A 137.90243902439025 137.90243902439025 0 0 1 70.08201653902371 93.56570513045506 L 114.50331075036542 112.44270833479578 A 89.63658536585366 89.63658536585366 0 0 0 156.01435945422253 227.21759344775964 L 133.94516839111157 270.1424514580917 z "
                                                                        fill="rgba(247,184,75,1)" fill-opacity="1"
                                                                        stroke-opacity="1" stroke-linecap="butt"
                                                                        stroke-width="0" stroke-dasharray="0"
                                                                        ...
                                                                        data:strokeWidth="0" data:value="41"
                                                                        data:pathOrig="M 133.94516839111157 270.1424514580917 A 137.90243902439025 137.90243902439025 0 0 1 70.08201653902371 93.56570513045506 L 114.50331075036542 112.44270833479578 A 89.63658536585366 89.63658536585366 0 0 0 156.01435945422253 227.21759344775964 L 133.94516839111157 270.1424514580917 z ">
                                                                    </path>
                                                                </g>
                                                                <g id="SvgjsG1993"
                                                                    class="apexcharts-series apexcharts-pie-series"
                                                                    seriesName="Other" rel="4"
                                                                    data:realIndex="3">
                                                                    <path id="SvgjsPath1994"
                                                                        d="M 70.08201653902371 93.56570513045506 A 137.90243902439025 137.90243902439025 0 0 1 125.16105646051803 29.787431087386466 L 150.3046866993367 70.9868302068012 A 89.63658536585366 89.63658536585366 0 0 0 114.50331075036542 112.44270833479578 L 70.08201653902371 93.56570513045506 z "
                                                                        fill="rgba(240,101,72,1)" fill-opacity="1"
                                                                        stroke-opacity="1" stroke-linecap="butt"
                                                                        stroke-width="0" stroke-dasharray="0"
                                                                        ...
                                                                        data:strokeWidth="0" data:value="17"
                                                                        data:pathOrig="M 70.08201653902371 93.56570513045506 A 137.90243902439025 137.90243902439025 0 0 1 125.16105646051803 29.787431087386466 L 150.3046866993367 70.9868302068012 A 89.63658536585366 89.63658536585366 0 0 0 114.50331075036542 112.44270833479578 L 70.08201653902371 93.56570513045506 z ">
                                                                    </path>
                                                                </g>
                                                                <g id="SvgjsG1997"
                                                                    class="apexcharts-series apexcharts-pie-series"
                                                                    seriesName="Referrals" rel="5"
                                                                    data:realIndex="4">
                                                                    <path id="SvgjsPath1998"
                                                                        d="M 125.16105646051803 29.787431087386466 A 137.90243902439025 137.90243902439025 0 0 1 196.9759314840471 9.597563075983999 L 196.98435546463062 57.8634159993896 A 89.63658536585366 89.63658536585366 0 0 0 150.3046866993367 70.9868302068012 L 125.16105646051803 29.787431087386466 z "
                                                                        fill="rgba(41,156,219,1)" fill-opacity="1"
                                                                        stroke-opacity="1" stroke-linecap="butt"
                                                                        stroke-width="0" stroke-dasharray="0"
                                                                        ...
                                                                        data:pathOrig="M 125.16105646051803 29.787431087386466 A 137.90243902439025 137.90243902439025 0 0 1 196.9759314840471 9.597563075983999 L 196.98435546463062 57.8634159993896 A 89.63658536585366 89.63658536585366 0 0 0 150.3046866993367 70.9868302068012 L 125.16105646051803 29.787431087386466 z ">
                                                                    </path>
                                                                </g>
                                                                <g id="SvgjsG1983" class="apexcharts-datalabels">
                                                                    <text id="SvgjsText1984"
                                                                        font-family="Helvetica, Arial, sans-serif"
                                                                        x="278.90306703702095" y="68.53551738252663"
                                                                        text-anchor="middle" dominant-baseline="auto"
                                                                ...
                                                                <g id="SvgjsG1987" class="apexcharts-datalabels">
                                                                    <text id="SvgjsText1988"
                                                                        font-family="Helvetica, Arial, sans-serif"
                                                                        x="254.4835674761729" y="245.67912902103114"
                                                                        text-anchor="middle" dominant-baseline="auto"
                                                                        font-size="12px" font-weight="600"
                                                                        fill="#ffffff"
                                                                        class="apexcharts-text apexcharts-pie-label"
                                                                ...
                                                                <g id="SvgjsG1991" class="apexcharts-datalabels">
                                                                    <text id="SvgjsText1992"
                                                                        font-family="Helvetica, Arial, sans-serif"
                                                                        x="90.01288016027023" y="186.1944194104952"
                                                                        text-anchor="middle" dominant-baseline="auto"
                                                                        font-size="12px" font-weight="600"
                                                                        fill="#ffffff"
                                                                        class="apexcharts-text apexcharts-pie-label"
                                                                ...
                                                                <g id="SvgjsG1995" class="apexcharts-datalabels">
                                                                    <text id="SvgjsText1996"
                                                                        font-family="Helvetica, Arial, sans-serif"
                                                                        x="110.89514851914218" y="73.13968493493711"
                                                                        text-anchor="middle" dominant-baseline="auto"
                                                                        font-size="12px" font-weight="600"
                                                                        fill="#ffffff"
                                                                        class="apexcharts-text apexcharts-pie-label"
                                                                ...
                                                                <g id="SvgjsG1999" class="apexcharts-datalabels">
                                                                    <text id="SvgjsText2000"
                                                                        font-family="Helvetica, Arial, sans-serif"
                                                                        x="166.21836480166087" y="37.97378012716601"
                                                                        text-anchor="middle" dominant-baseline="auto"
                                                                        font-size="12px" font-weight="600"
                                                                        fill="#ffffff"
                                                                        class="apexcharts-text apexcharts-pie-label"
                                                    ...
                                                    <line id="SvgjsLine2001" x1="0" y1="0"
                                                        x2="394" y2="0" stroke="#b6b6b6"
                                                        stroke-dasharray="0" stroke-width="1" stroke-linecap="butt"
                                                        class="apexcharts-ycrosshairs"></line>
                                                    <line id="SvgjsLine2002" x1="0" y1="0"
                                                        x2="394" y2="0" stroke-dasharray="0"
                                                        stroke-width="0" stroke-linecap="butt"
                                                        class="apexcharts-ycrosshairs-hidden"></line>
                                                </g>
                                                <g id="SvgjsG1975" class="apexcharts-datalabels-group"
                                                    transform="translate(0, 0) scale(1)"></g>
                                                <g id="SvgjsG1976" class="apexcharts-datalabels-group"
                                                    transform="translate(0, 0) scale(1)"></g>
                                            </svg>
                                            <div class="apexcharts-tooltip apexcharts-theme-dark">
                                                ...
                                                <div class="apexcharts-tooltip-series-group apexcharts-tooltip-series-group-4"
                                                    style="order: 5;"><span class="apexcharts-tooltip-marker"
                                                        style="background-color: rgb(41, 156, 219);"></span>
                                                    <div class="apexcharts-tooltip-text"
                                                        style="font-family: Helvetica, Arial, sans-serif; font-size: 12px;">
                                                        <div class="apexcharts-tooltip-y-group"><span
                                                                class="apexcharts-tooltip-text-y-label"></span><span
                    ...
                    <div class="card h-100 rounded-0">
                        <div class="card-body p-0">
                            ...
                            <div data-simplebar="init" style="max-height: 410px;"
                                class="p-3 pt-0 simplebar-scrollable-y">
                                <div class="simplebar-wrapper" style="margin: 0px -16px -16px;">
                                                        ...
                                                        <div class="acitivity-item py-3 d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h6 class="mb-1 lh-base">Added new <span
                                                                        class="fw-semibold">style collection</span>
                                                                </h6>
                                                        ...
                                                        <div class="acitivity-item py-3 d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h6 class="mb-1 lh-base">Natasha Carey have liked the
                                                                    products</h6>
                                                                <p class="text-muted mb-1">Allow users to like
                                                                    products in your WooCommerce store.</p>
                                                        ...
                                                        <div class="acitivity-item d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                ...
                                                                <p class="text-muted mb-2 fst-italic">" A product that
                                                                    has reviews is more likable to be sold than a
                                                                    product. "</p>
                                    ...
                                    <div class="simplebar-placeholder" style="width: 280px; height: 1048px;"></div>
                                </div>
                            ...
                            <div class="p-3">
                                ...
                                <!-- Swiper -->
                                <div class="swiper vertical-swiper swiper-initialized swiper-vertical swiper-backface-hidden"
                                    style="height: 250px;">
                                    <div class="swiper-wrapper" id="swiper-wrapper-110d886777af466f1" aria-live="off"
                                        style="transition-duration: 0ms; transform: translate3d(0px, -260px, 0px); transition-delay: 0ms;">




                                        <div class="swiper-slide" role="group" aria-label="4 / 4"
                                            data-swiper-slide-index="3" style="height: 120px; margin-bottom: 10px;">
                                        ...
                                        <div class="swiper-slide swiper-slide-prev" role="group" aria-label="1 / 4"
                                            data-swiper-slide-index="0" style="height: 120px; margin-bottom: 10px;">
                                            <div class="card border border-dashed shadow-none">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                        ...
                                        <div class="swiper-slide swiper-slide-next" role="group" aria-label="3 / 4"
                                            data-swiper-slide-index="2" style="height: 120px; margin-bottom: 10px;">
                                            <div class="card border border-dashed shadow-none">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0 avatar-sm">
