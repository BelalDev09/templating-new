                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item"
                                    href="{{ asset('Backend/assets/pages/pages-profile.html') }}"><i
                                        class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span
                                        class="align-middle">Profile</span></a>
                                <a class="dropdown-item" href="{{ asset('Backend/assets/pages/apps-chat.html') }}"><i
                                        class="mdi mdi-message-text-outline text-muted fs-16 align-middle me-1"></i>
                                    <span class="align-middle">Messages</span></a>
                                <a class="dropdown-item"
                                    href="{{ asset('Backend/assets/pages/apps-tasks-kanban.html') }}"><i
                                ...
                                <a class="dropdown-item"
                                    href="{{ asset('Backend/assets/pages/pages-profile-settings.html') }}"><span
